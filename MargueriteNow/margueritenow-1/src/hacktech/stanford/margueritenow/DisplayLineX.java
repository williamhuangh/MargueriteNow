...
public class DisplayLineX extends Activity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_display_line_x);
//		
//		Button b1 = (Button)findViewById(R.id.Palo_Alto_Transit_Center);
//		b1.setText("LOL");														// TODO: set text to button arraylist 
	}

	@Override
	public boolean onCreateOptionsMenu(Menu menu) {
		// Inflate the menu; this adds items to the action bar if it is present.
		getMenuInflater().inflate(R.menu.display_line_x, menu);
		return true;
	}
